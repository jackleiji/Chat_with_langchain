...
class Item(BaseModel):
    ...
    temperature : float = 0.5 # 1 > 温度系数 > 0 
    ...
    # 数据库路径
    db_path : str = "E:/CATL/2.项目与比赛/llm-universe/data_base/vector_db/chroma"
    # 源文件路径
    file_path : str = "E:/CATL/2.项目与比赛/Chat_with_Datawhale_langchain/knowledge_db"
    # prompt template
